...
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_EMAIL_BLANK;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_EMAIL_EMPTY;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_EMAIL_INVALID;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_EMAIL_NULL;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_FIRST_NAME_BLANK;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_FIRST_NAME_EMPTY;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_FIRST_NAME_MAX_LENGTH;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_FIRST_NAME_NULL;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_LAST_NAME_BLANK;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_LAST_NAME_EMPTY;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_LAST_NAME_MAX_LENGTH;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_LAST_NAME_NULL;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_PASSWORD_BLANK;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_PASSWORD_EMPTY;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_PASSWORD_MAX_LENGTH;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_PASSWORD_MIN_LENGTH;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.INVALID_REGISTER_USER_REQUEST_PASSWORD_NULL;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.VALID_REGISTER_USER_REQUEST;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.VALID_REGISTER_USER_REQUEST_FIRST_NAME_MAX_LENGTH;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.VALID_REGISTER_USER_REQUEST_LAST_NAME_MAX_LENGTH;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.VALID_REGISTER_USER_REQUEST_PASSWORD_MAX_LENGTH;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.VALID_REGISTER_USER_REQUEST_PASSWORD_MIN_LENGTH;
import static com.vet.hc.api.auth.core.data.RegisterUserDataProvider.VALID_REGISTER_USER_RESPONSE_CONTENT;
