...
public final class TreatmentPersistenceAdapter implements TreatmentRepository {
    private TreatmentHibernateRepository treatmentHibernateRepository;
    ...
    @Inject
    public TreatmentPersistenceAdapter(
            TreatmentHibernateRepository treatmentHibernateRepository) {
        this.treatmentHibernateRepository = treatmentHibernateRepository;
    }
