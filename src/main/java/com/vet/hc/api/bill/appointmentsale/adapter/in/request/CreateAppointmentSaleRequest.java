package com.vet.hc.api.bill.appointmentsale.adapter.in.request;
...
/**
 * Request payload to create a new appointmentSale.
 */
@Getter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public final class CreateAppointmentSaleRequest implements CreateAppointmentSalePayload {
