package com.vluepixel.vetmanager.api.user.core.adapter.out.persistence.converter;

import java.util.List;
import java.util.stream.Collectors;

import com.vluepixel.vetmanager.api.shared.adapter.out.persistence.converter.ListEnumAttributeConverter;
