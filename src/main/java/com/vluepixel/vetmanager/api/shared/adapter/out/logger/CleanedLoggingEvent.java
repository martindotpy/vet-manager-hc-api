package com.vluepixel.vetmanager.api.shared.adapter.out.logger;
...
/**
 * Wrapper class for an ILoggingEvent that provides a cleaned message (removed
 * of ASCII color codes).
 */
